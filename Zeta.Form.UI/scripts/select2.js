...
(function ($, undefined) {
    ...
    createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   <span>&nbsp;</span><abbr class='select2-search-choice-close icon-remove'></abbr>",
                "   <div><b></b></div>" ,
                "</a>",
        ...
        addSelectedChoice: function (data) {
            var enableChoice = !data.locked,
                enabledItem = $(
                    ...
                    "    <div></div>" +
                    "    <a href='#' onclick='return false;' class='select2-search-choice-close icon-remove icon-white' tabindex='-1'></a>" +
                    "</li>"),
                disabledItem = $(
