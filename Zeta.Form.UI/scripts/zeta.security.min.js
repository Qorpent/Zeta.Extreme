 ...
 */
!function($) {
    var zefsdebug = new root.Widget("zefsdebug", root.Console.layout.position.layoutHeader, "right", { authonly: true, adminonly: true });
...
/**
 * Виджет формы входа от имени другого пользователя
 */
!function($) {
    var impersonator = new root.Widget("impersonator", root.Console.layout.position.layoutHeader, "right", { authonly: true, adminonly: true });
    var b = $('<button class="btn btn-small dropdown-toggle" data-toggle="dropdown" data-original-title="Вход от имени"/>').html('<i class="icon-user"></i><span class="caret"></span>');
    var m = $('<div class="btn-group pull-right"/>').append(
        b, $('<ul class="dropdown-menu"/>'));
    b.tooltip({placement: 'bottom'});
    impersonator.body = $('<div/>').append(m);
//    root.Console.registerWidget(impersonator);
}(window.jQuery);
...
!function($) {
    ...
    var b = $('<button class="btn btn-small dropdown-toggle" data-toggle="dropdown" data-original-title="Вход от имени"/>')
        .html('<i class="icon-user"></i><span class="caret"></span>');
    var m = $('<div class="btn-group pull-right"/>').append(
        b, $('<ul class="dropdown-menu"/>'));


    var logininfo = $('<div class="login-info"/>').append(logininfolabel, m).hide();
