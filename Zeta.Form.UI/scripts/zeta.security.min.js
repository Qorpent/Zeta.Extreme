...
!function($) {
    ...
    var btngroup = $('<div class="btn-group"/>').append(
        $('<a class="btn btn-small"/>').html('<i class="icon-list"></i>'),
        $('<a class="btn btn-small dropdown-toggle" data-toggle="dropdown" href="#"/>').html('<span class="caret"></span>'),
        $('<ul class="dropdown-menu"/>').append(
            $('<li/>').html('<a href="#" id="sessionInfo"><i class="icon-globe"></i> Session</a>'),
            $('<li/>').html('<a href="#" id="debugInfo"><i class="icon-warning-sign"></i> Debug</a>'),
            $('<li/>').html('<a href="#" id="restartInfo"><i class="icon-repeat"></i> Restart</a>')
        )
    );
    sessionInfo.body = $('<div/>').append(btngroup);
...
!function($) {
    ...
    var status = $('<span class="label"/>').text("Не определено");
