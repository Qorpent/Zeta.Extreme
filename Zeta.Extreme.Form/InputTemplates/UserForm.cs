...
namespace Zeta.Extreme.Form.InputTemplates {
	...
	/// 	Шаблон формы
	/// </summary>
	public class UserForm : IUserForm, ICloneable, IConditionMatcher {
		/// <summary>
...
#pragma warning restore 612,618
		...
		*/
		...
		/// </summary>
		public IList<IUserForm> Sources {
			get { return sources; }
		}
		...
		*/
		...
		/// <param name="obj"> </param>
		/// <returns> </returns>
		public IUserForm PrepareForPeriod(int year, int period, DateTime directDate, IZetaMainObject obj) {
		...
		/// </summary>
		/// <returns> </returns>
		public IUserForm Clone() {
			var result = new UserForm();
		...
		private readonly IList<IUserForm> sources = new List<IUserForm>();
