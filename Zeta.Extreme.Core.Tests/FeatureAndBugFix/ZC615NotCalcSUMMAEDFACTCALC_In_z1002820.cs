...
namespace Zeta.Extreme.Core.Tests {
    ...
    public class ZC615NotCalcSUMMAEDFACTCALC_In_z1002820 : SessionTestBase
    {
        ...
        public void ZC615_Test_Right_No_Colin()
        {
            var q = session.Register(new Query
            {
                Row = { Code = "ZC615_Test_Right_No_Colin", IsFormula = true, FormulaType = "boo", Formula = "$m216250@Á1.toparentobj()? * $z1002500@SUMMA? / $z1002500@SUMMA.consobj(\"_PARENT.CLASS\")? / f.choose( $__OFS@__OFK?, $__OFS@__OFK.torootobj()? ) * ___KMULT " },
                Col = { Code = "SUMMAEDFACTCALC" },
                Time = { Year = 2013, Period = 406 },
                Obj = { Id = 3800 },
            });
        ...
        [TestCase("$m216250@Á1.toparentobj()?")]
