...
namespace Zeta.Extreme.Core.Tests.SubQuery {
	...
	public class FormulaCompilerTest {
		private string _formula = @"f.If ( year == 2011 and periodin ( 4,112 ) and colin ('Á1',""PLAN"") , { - $m1111216@DELTA? - $r2161111@Ok.P4? - $r2161131@Ok.P4? } , {
...
", new FormulaRequest { Language = "boo" });
			...
			Assert.AreEqual(@"f.If ( year == 2011 and periodin ( 4,112 ) and colin (""Á1"",""PLAN"") , { - EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""m1111216"", ColCode = ""DELTA"", }) - EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""r2161111"", ColCode = ""Ok"", Period = 4, }) - EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""r2161131"", ColCode = ""Ok"", Period = 4, }) } , {
f.If ( year == 2011 or (  year == 2012 and periodin ( 301,251,252,303,306,309 ) ) , { f.If ( colin(""PLANC"") , { EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""m1111216"", ColCode = ""PLANC"", }) }, { f.If ( colin (""Á1"",""PLAN""), { - EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""m1111216"", ColCode = ""DELTA"", }) } ) } ) }, { f.If ( year < 2011 , { f.If ( colin(""PLANC"") , { EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""m211216"", ColCode = ""PLANC"", }) }, { f.If ( colin (""Á1"",""PLAN""), { - EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""m211216"", ColCode = ""DELTA"", }) } ) } ) } , { f.If ( colin (""Á1"",""PLAN""), { EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""r2161200"", ColCode = ""Rd"", }) - EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""r2161200"", ColCode = ""Pd"", }) } ) } ) } ) } )".Trim(), result.Trim());
		}
		...
		public void CanBeParsed_Deltas_And_Lambdas_FromRealWorldFormula()
		{
			...
			Assert.AreEqual(@"f.If ( year == 2011 && periodin ( 4,112 ) && colin (""Á1"",""PLAN"") , ()=>( - EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""m1111216"", ColCode = ""DELTA"", }) - EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""r2161111"", ColCode = ""Ok"", Period = 4, }) - EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""r2161131"", ColCode = ""Ok"", Period = 4, }) ) , ()=>(
f.If ( year == 2011 || (  year == 2012 && periodin ( 301,251,252,303,306,309 ) ) , ()=>( f.If ( colin(""PLANC"") , ()=>( EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""m1111216"", ColCode = ""PLANC"", }) ), ()=>( f.If ( colin (""Á1"",""PLAN""), ()=>( - EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""m1111216"", ColCode = ""DELTA"", }) ) ) ) ) ), ()=>( f.If ( year < 2011 , ()=>( f.If ( colin(""PLANC"") , ()=>( EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""m211216"", ColCode = ""PLANC"", }) ), ()=>( f.If ( colin (""Á1"",""PLAN""), ()=>( - EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""m211216"", ColCode = ""DELTA"", }) ) ) ) ) ) , ()=>( f.If ( colin (""Á1"",""PLAN""), ()=>( EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""r2161200"", ColCode = ""Rd"", }) - EvalDelta( new Zeta.Extreme.ZexQueryDelta{ RowCode = ""r2161200"", ColCode = ""Pd"", }) ) ) ) ) ) ) ) )
