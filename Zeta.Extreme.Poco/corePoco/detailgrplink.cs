...
using Comdiv.Zeta.Model;namespace Zeta.Extreme.Poco{
    public partial class detailgrplink : IZetaDetailObjectGroupLink{
        ...
        #region IZetaDetailObjectGroupLink Members
        ...
        [Ref(ClassName = typeof (detailgrp))]
        public virtual IDetailObjectGroup<IZetaMainObject, IZetaDetailObject> DetailObjectGroup { get; set; }
