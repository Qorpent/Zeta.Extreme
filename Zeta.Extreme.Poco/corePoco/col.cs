...
namespace Zeta.Extreme.Poco {
	public partial class col : IZetaColumn, IZetaQueryDimension {
		...
		/// </summary>
		[Deprecated.NoMap] public virtual int Year { get; set; }

		/// <summary>
		/// 	Поддержка режима "колонка как заместитель колсета"
		/// </summary>
		[Deprecated.NoMap] public virtual int Period { get; set; }

		/// <summary>
		/// 	Поддержка режима "колонка как заместитель колсета"
		/// </summary>
		[Deprecated.NoMap] public virtual string ForeignCode { get; set; }
		...
		[Deprecated.Map] public virtual string DataTypeDetail { get; set; }


		[Deprecated.Many(ClassName = typeof (ColumnMark))] public virtual IList<IZetaColumnMark> MarkLinks {
