<Project ToolsVersion="4.0" DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
	...
	<!--  INSTALL MANIFEST OF Zeta.Extreme PACKAGE 
	...
	<PropertyGroup>
		...
		<PackageCondition Condition="'$(Zeta_Extreme)'=='True' or '$(CustomPackageCondition)'=='True' ">True</PackageCondition>
	...
	<ItemGroup>
		...
		-->
			...
			<Library Include="Zeta.Extreme.Core" />
			<Library Include="Zeta.Extreme.Form" />
			<Library Include="Zeta.Extreme.FrontEnd" />
			<Config Include="*.base.ioc-manifest.bxl"/>
			
			<!--dependency -->
			<Library Include="Comdiv.Zeta.Model" />
			<Library Include="Comdiv.Zeta.Model.Implementation" />
			<Library Include="Comdiv.Core" />
			<Library Include="Comdiv.Dependency" />
			<Library Include="Nhibernate" />
			<Library Include="FluentNHibernate" />
			<Library Include="Iesi.Collections" />
